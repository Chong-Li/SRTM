...
if args.type == "fanout" or args.type == "all":
    if args.ctype == "tcp" or args.ctype == "all":
        for i in [6,7,8,9]:
            ...
            os.system("./Consumer -c tcp -a="+ args.address +" -l="+str(args.length)+" -s="+ str(args.stopnum) +" -rl="+str(args.records)+" -pn 1 -n="+str(1)+ \
    ...
    if args.ctype == "udp" or args.ctype == "all":
        for i in [6,7,8,9]:
            ...
            os.system("./Consumer -c udp -a="+ args.address +" -l="+str(args.length)+" -s="+ str(args.stopnum) +" -rl="+str(args.records)+" -pn 1 -n="+str(1)+ \
    ...
    if args.ctype == "multicast" or args.ctype == "all":
        for i in [6,7,8,9]:
            ...
            os.system("./Consumer -c multicast -a="+ args.address +" -l="+str(args.length)+" -s="+ str(args.stopnum) +" -rl="+str(args.records)+" -pn 1 -n="+str(1)+ \
