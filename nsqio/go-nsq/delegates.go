...
type ConnDelegate interface {
	...
	// OnMessageNull is called when the connection
	// handles a NULL command from a message handler
	OnMessageNull(*Conn, *Message)

	// OnMessageFinished is called when the connection
	// handles a NACK command from a message handler
	OnMessageNacked(*Conn, *Message)
...
func (d *consumerConnDelegate) OnMessageNull(c *Conn, m *Message)     {}
func (d *consumerConnDelegate) OnMessageNacked(c *Conn, m *Message)   { d.r.onConnMessageNacked(c, m) }
...
func (d *producerConnDelegate) OnMessageNacked(c *Conn, m *Message)   {}
func (d *producerConnDelegate) OnMessageNull(c *Conn, m *Message)     {}
