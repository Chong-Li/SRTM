...
type Config struct {
	...
	// the interface to use when use multicast
	Intf string `opt:"interface"`
	...
	// jarry connection type
	// ConnType          int `opt:"connection_type" default:"0" min:"0"`
	DefaultBufferSize int           `opt:"buffer_size" default:"10240"`
	ResendTimeout     time.Duration `opt:"resend_timeout" default:"100ms"`
	MaxHardTimeout    time.Duration `opt:"max_hard_timeout" default:"400ms"`

	//RTM.dtb
	MTCPConn int `opt:"mtcp_conn" default:"1"`
}
