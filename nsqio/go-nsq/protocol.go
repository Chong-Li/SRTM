...
// ReadAddr reads the source address of the message,
// for multicast connect, call readAddr before calling ReadUnpackedResponse
func ReadAddr(r io.Reader) (net.IP, error) {
	var addrSize int32
	err := binary.Read(r, binary.BigEndian, &addrSize)
	if err != nil {
		return nil, err
	}
