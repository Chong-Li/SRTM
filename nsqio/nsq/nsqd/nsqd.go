...
import (
	...
	"github.com/WU-CPSL/RTM-0.1/nsqio/nsq/internal/clusterinfo"
	"github.com/WU-CPSL/RTM-0.1/nsqio/nsq/internal/dirlock"
	"github.com/WU-CPSL/RTM-0.1/nsqio/nsq/internal/http_api"
	"github.com/WU-CPSL/RTM-0.1/nsqio/nsq/internal/protocol"
	"github.com/WU-CPSL/RTM-0.1/nsqio/nsq/internal/statsd"
...
const (
	ConnTypeDefault   = 0
	ConnTypeTCP       = 0 // default
	ConnTypeMulticast = 1
	ConnTypeMTCP      = 2 //RTM.dtb
)
...
func (n *NSQD) GetTopic(topicName string) *Topic {
	...
	//n.GetDefaultChannel(topicName, t)
...
func (n *NSQD) channels() []*Channel {
	...
	for _, t := range n.topicMap {
		...
		for _, c := range t.channelMap {
			if c.name != "multicast" { // exclude multicast
