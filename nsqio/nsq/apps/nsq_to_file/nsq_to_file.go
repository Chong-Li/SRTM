...
func main() {
	...
	flag.Var(&nsq.ConfigFlag{cfg}, "consumer-opt", "option to passthrough to nsq.Consumer (may be given multiple times, http://godoc.org/github.com/WU-CPSL/RTM-0.1/nsqio/go-nsq#Config)")
